...
contract USDtoINR is ChainlinkClient, ConfirmedOwner {
    ...
    function requestRateData() public returns (bytes32 requestId) {
        ...
        // https://min-api.cryptocompare.com/data/pricemultifull?fsyms=USD&tsyms=INR
        req.add('get', 'https://openexchangerates.org/api/latest.json?app_id=7e39bd843ff444c493c38c7952d06aaa');
        ...
        req.add('path', 'rates,INR'); // Chainlink nodes 1.0.0 and later support this format
